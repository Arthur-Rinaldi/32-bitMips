...
HD_PWD='C:/Users/USER/Documents/GitHub/32-bitMips/project_org/project_org.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miTo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miTo.tcl
